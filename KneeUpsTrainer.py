...
def run():
    ...
    #Angle range for a knee up (hip-knee-ankle)
    ...
    while True:
        ...
        if landmarks_available(lmList, right_leg_points):
            ...
            if duration_visible > VISIBILITY_THRESHOLD:
                ...
                if percentage_right >= 95 and dir_right == 0: count, dir_right = count + 0.5, 1
        ...
        if landmarks_available(lmList, left_leg_points):
            ...
            if duration_visible > VISIBILITY_THRESHOLD:
                ...
                if percentage_left >= 95 and dir_left == 0: count, dir_left = count + 0.5, 1
        ...
        cv.putText(img, "KNEE UPS", (540, 560), cv.FONT_HERSHEY_PLAIN, 3, (255, 255, 255), 3)
        ...
        cv.imshow('GymGuardian - Knee Ups', img)
